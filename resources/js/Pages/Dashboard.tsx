    ...
    return (
        ...
        >
                ...
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="flex justify-between">
                            ...
                            <div className="p-6">
                                <PrimaryButton
                                    onClick={() => setGenerateNewAPIKey(true)}
                                >
                        ...
                        <div className="flex flex-col space-y-3 p-6">
                            {auth.user.tokens && auth.user.tokens.length > 0 ? (
                                auth.user.tokens.map((token) => (
                                    <div>
            ...
            <Modal
                ...
                onClose={() => setGenerateNewAPIKey(false)}
            >
                <form onSubmit={generateToken} className="p-6">
                    ...
                    <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">
                        To generate a new API key, add a new Key name below and
                        then press create.
                        <br />
                        Please note, that once created you will only be able to
                        see your token once.
                    </p>
                    ...
                    <div className="mt-6">
                        ...
                        <TextInput
                            ...
                            onChange={(e) =>
                                setData("token_name", e.target.value)
                            }
                    ...
                    <div className="mt-6 flex justify-end">
                        <PrimaryButton
                            onClick={() => setGenerateNewAPIKey(false)}
                            disabled={processing}
                        >
                            Create
                        </PrimaryButton>
